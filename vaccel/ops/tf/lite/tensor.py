...
class TensorTypeMapper:
    ...
    _TENSOR_TYPE_TO_C: Final[dict[TensorType, (str, int)]] = {
        TensorType.FLOAT32: ("float", ffi.sizeof("float")),
        ...
        TensorType.FLOAT64: ("double", ffi.sizeof("double")),
    ...
    if HAS_NUMPY:
        _NUMPY_TO_TENSOR_TYPE = {
            np.dtype("float32"): TensorType.FLOAT32,
            ...
            np.dtype("float64"): TensorType.FLOAT64,
...
class Tensor(CType):
    ...
    def as_bytelike(self) -> bytes | bytearray | memoryview:
        """The tensor data buffer as a byte-like object.
    ...
    def as_memoryview(self) -> memoryview:
        """The tensor data buffer as memoryview.
    ...
    def to_bytes(self) -> bytes:
        """The tensor data buffer as bytes.
